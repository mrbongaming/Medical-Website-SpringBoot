    ...
    <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 min-h-[55vh] py-10 sm:py-14">
      ...
      <div className="grid min-w-0 gap-6 lg:grid-cols-[17rem_minmax(0,1fr)]">
        <aside className="self-start lg:sticky lg:top-24">
          <div className="grid gap-4 rounded-xl border border-slate-200 bg-white p-4 sm:grid-cols-2 lg:grid-cols-1">
            <div className="sm:col-span-2 lg:col-span-1">
              <h2 className="font-bold text-brand-900">Lọc kết quả</h2>
              <p className="mt-1 text-sm text-slate-500">Chọn tiêu chí phù hợp với nhu cầu khám.</p>
            </div>
            ...
            {(query || branchId || specialtyId) && (
              <button
                type="button"
                className="min-h-10 rounded-lg border border-slate-300 bg-white px-3 font-semibold text-slate-700 hover:border-sky-400 hover:text-sky-700"
        ...
        <section className="min-w-0">
          <p className="mb-4 text-slate-500">{rows.length} kết quả phù hợp</p>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Link
                      ...
                      to={
                        kind === 'packages' ? '/goi-kham/' + r.slug : '/bac-si?specialtyId=' + r.id
                      }
                    >
