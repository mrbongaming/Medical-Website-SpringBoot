...
- Phiên bản dữ liệu là **v4**, giữ khóa `antam-data-v1` để tự nâng cấp từ v1/v2/v3. Nâng cấp giữ tài khoản, lịch hẹn, bệnh án và phiếu thu; thêm bảng phí tương đương giá cũ khi cần, kho thuốc theo cơ sở và tài khoản nhân viên mẫu. Dữ liệu cũ không bị gán đơn thuốc hoặc trừ kho hồi tố.
...
- Nhân viên/admin cơ sở duyệt hồ sơ và tiếp nhận; bác sĩ có thể lưu nháp, kê đơn từ tồn khả dụng và chỉ hoàn tất lịch đã tiếp nhận. Hoàn tất khám giữ thuốc và ghi bản chụp đơn vào bệnh án; nhân viên cấp thuốc sau thanh toán. Giá dịch vụ và thuốc đã ghi nhận được giữ khi bảng giá thay đổi.
